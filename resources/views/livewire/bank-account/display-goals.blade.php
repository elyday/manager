                ...
                @foreach ($goals as $goal)
                    <tr>
                        ...
                        <td>
                            @can('update', $goal)
                                @if ($goal->endedAt === null)
                                    <a href="#" wire:click="completeGoal({{ $goal->id }})" data-toggle="tooltip"
                                        data-playment="top" title="Ziel abschließen">
                            ...
                            @can('delete', $goal)
                                <a href="#" wire:click="deleteGoal({{ $goal->id }})" data-toggle="tooltip"
                                    data-playment="top" title="Ziel löschen">
